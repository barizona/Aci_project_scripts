...
composit_ABC <- plot_grid(p_A, p_B, p_C,
                          ...
                          label_size = 12, label_fontfamily = "Arial",
                          nrow = 1, align = "h")


composit_DE <- plot_grid(grImport2::pictureGrob(p_D), 
                         plot_grid(NULL, p_E, NULL, ncol = 1, align = "h", 
                                   rel_heights = c(0.22, 1, 0.22)), 
                         NULL,
...
composit_FGH <- plot_grid(p_F, p_G, p_H, 
                          labels = c("F", "G", "H"), label_fontface = "plain", 
                          label_size = 12, label_fontfamily = "Arial",
                          nrow = 1, align = "h")
...
ggsave("output/Figure6_orig.pdf", p, units = "in", height = 8.3, width = 8.5, 
       device = cairo_pdf)

# with Inkscape move the superscript R to the right place in F and save as Figure6.pdf
